...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "GZTLdW_1CE7ZQL-2s32cGSqdjsaslitRPjjmZxnm";
    private static final String SECRETKEY = "blHkFmUPbGnhG1PHNs5RxfurmQ6-VfI_TY2HSRm2";
    private static final String BUCKET = "myindeximg";
    public static final String DOMAIN = "qm6pa2i5y.hn-bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("D:\\2.png","dd2.png");
    ...
    public static List<String> removeFiles(String... filenames){
        ...
        if(filenames.length > 0){
            ...
            try {
                ...
                e.printStackTrace();
                throw new RuntimeException("有异常，请重试");
            }
        }
